...
- (OTCover*)initWithTableViewWithHeaderImage:(UIImage*)headerImage withOTCoverHeight:(CGFloat)height{
    ...
    // 蒙版
    UIImageView * imageM = [[UIImageView alloc] initWithFrame:CGRectMake(0, height - 20, bounds.size.width, 20)];
    imageM.backgroundColor = RGBR(180, 180, 180, 0.2);
    [self.tableView addSubview:imageM];
    
    // 初始化textLabel
    self.textLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, height - 20, bounds.size.width - 10, 20)];
